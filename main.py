...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    # existing_patient_info -> pydantic model(Patient) -> update bmi + verdict
    ...
    return JSONResponse(status_code = 200, content = {'message': 'Patient data updated XD'})
...
def delete_patient(patient_id: str):
    ...
    return JSONResponse(status_code = 200, content = {'message': 'Patient daleted XD'})